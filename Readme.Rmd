...
`Script.rmd` represents the R notebook. The notebook describes the use of partial least squares (pls) on a BRCA1 expression dataset in order to predict the activity of BRCA1 expression.
